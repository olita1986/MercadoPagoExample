...
class InstallmentTableViewCell: UITableViewCell {
    ...
    func setupCell(withInstallment installment: InstallmentSelection.Installment.ViewModel.DisplayedInstallment) {
        ...
        recommendation.text = installment.recommendedMessage
    }
